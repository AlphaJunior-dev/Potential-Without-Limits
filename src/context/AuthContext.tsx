...
const INITIAL_SPONSORS: PendingSponsor[] = [
  {
    id: "sp-mock",
    name: "WLP Official Partner",
    email: "sponsor@wlp.org",
    company: "WLP Global Impact Network",
    linkedin: "https://linkedin.com/company/wlp-impact",
    status: "approved",
  ...
  },
  {
    ...
    email: "e.andersen@visionarycorp.com",
    company: "Visionary Corp",
    linkedin: "https://linkedin.com/in/eleanor-a",
    status: "pending",
  ...
  },
  {
    id: "sp-2",
    name: "Marcus Knight",
    email: "marcus.knight@impactfund.io",
    company: "Impact Fund VC",
    linkedin: "https://linkedin.com/in/mknight-vc",
    status: "pending",
    callStatus: "Call Scheduled",
