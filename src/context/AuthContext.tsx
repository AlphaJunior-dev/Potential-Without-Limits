...
export function AuthProvider({ children }: { children: React.ReactNode }) {
  ...
  const loadAdminData = async (authenticatedUser: User) => {
    ...
    setAdminProfiles(records.map((record: FlexibleRecord) => ({
      ...
      publicVisibility: {
        ...
        educationLevelVisible: record.visibility?.educationLevelVisible === true,
  ...
  const loadApprovedSponsorProfiles = async (authenticatedUser: User) => {
    ...
    setSponsorProfiles(talent.map((record: FlexibleRecord) => {
      ...
      return {
        ...
        publicVisibility: { profileVisible: true, photoVisible: true, mediaVisible: true, summaryVisible: true, educationLevelVisible: true },
        ...
        educationLevel: typeof record.educationLevel === "string" ? record.educationLevel : "",
  ...
  const saveTalentRecord = async (profile: YouthProfile, id?: string) => {
    ...
    const visibility = {
      ...
      educationLevelVisible: profileVisible && requestedVisibility?.educationLevelVisible === true,
