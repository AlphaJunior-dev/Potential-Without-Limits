  ...
  return NextResponse.json({
    ...
    profiles: site.pilotCards.map((card) => {
      ...
      return {
        ...
        location: "Sponsor Talent",
        country_community: "Sponsor Talent",
        bio: card.summary,
        ...
        skills: [],
        dream: card.summary,
        current_situation: "Information is shared through appropriate private conversations.",
        progress: "",
        current_needs: card.supportArea || "Orientation conversation",
