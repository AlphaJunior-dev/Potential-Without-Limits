  ...
  return (
    <div className="min-h-screen bg-[#FCFCFA] font-inter text-[#0B2E6B] py-12 px-4 sm:px-6 lg:px-8 bg-foundation-pattern">
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <div className="bg-white p-8 sm:p-12 rounded-3xl border border-[#0B2E6B]/10 shadow-2xl space-y-8">
          <div className="flex items-center gap-4 border-b border-[#0B2E6B]/10 pb-6">
            <div className="w-14 h-14 rounded-2xl bg-[#079432]/10 text-[#079432] border border-[#079432]/20 flex items-center justify-center shrink-0">
            ...
            <div>
              ...
              <p className="text-xs text-[#0B2E6B]/60 mt-1">
                Potential Without Limits International Foundation (PWLIF) • Ethical Governance &amp; Privacy Protocol
              </p>
            </div>
          </div>

          <div className="space-y-6 text-sm text-[#0B2E6B]/85 leading-relaxed font-inter">
            {/* Section 1: Controlled publication */}
            <div className="p-6 rounded-2xl bg-[#F8FAFC] border border-[#0B2E6B]/10 space-y-3">
              <div className="flex items-center gap-2 text-[#079432] font-montserrat font-bold text-base">
                <FileCheck className="w-5 h-5" />
                <h2>1. Controlled Publication</h2>
              </div>
              <p className="text-xs text-[#0B2E6B]/80 leading-relaxed">
          ...
          <div className="pt-6 border-t border-[#0B2E6B]/10 flex flex-col sm:flex-row sm:items-center justify-between gap-4 text-xs text-[#0B2E6B]/60">
            <span className="flex items-center gap-1.5 font-bold text-[#079432]">
              <ShieldCheck className="w-4 h-4 text-[#079432]" />
              Safeguarding &amp; Privacy Framework • PWLIF
            </span>
            <Link href="/book-a-call" className="text-[#079432] font-bold hover:underline">
