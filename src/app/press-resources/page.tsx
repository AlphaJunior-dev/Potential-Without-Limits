  ...
  return (
    <main className="overflow-x-hidden bg-[#FCFCFA] text-[#0B2E6B]">
      <PublicHero
        ...
        title="Accurate context for responsible coverage."
        intro="PWLIF provides public information that helps partners, journalists, and community stakeholders understand the foundation without compromising privacy or overstating its work."
      ...
      <section className="bg-[#F2F8F4] px-5 py-20 sm:px-8 sm:py-24 lg:px-10"><div className="mx-auto max-w-7xl"><SectionHeading eyebrow="Available materials" title="No press pack or published resources are available yet." intro="Official resource documents, approved statements, and media materials will be added here once PWLIF has reviewed them for public release." /><div className="mt-10 rounded-[1.7rem] border border-[#0B2E6B]/10 bg-white p-7 sm:p-9"><div className="flex gap-4"><Mail className="h-7 w-7 shrink-0 text-[#079432]" /><div><h2 className="font-montserrat text-2xl font-black">Need to contact PWLIF?</h2><p className="mt-2 max-w-2xl text-sm leading-7 text-[#0B2E6B]/70">Use the support enquiry route to request appropriate context. PWLIF will respond through its review process and will not provide private Talent records through public channels.</p><Link href="/support" className="mt-5 inline-flex items-center gap-2 text-sm font-bold text-[#079432] hover:text-[#14B84A]">Contact PWLIF <ArrowUpRight className="h-4 w-4" /></Link></div></div></div></div></section>
