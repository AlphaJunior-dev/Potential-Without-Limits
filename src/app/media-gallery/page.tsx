  ...
  return (
    <main className="overflow-x-hidden bg-[#FCFCFA] text-[#0B2E6B]">
      <PublicHero
        ...
        title={hasPublishedEditorial && editorial.title ? editorial.title : "Images and film, published with permission."}
        intro={hasPublishedEditorial && editorial.introduction ? editorial.introduction : "This gallery is reserved for approved PWLIF media. The foundation does not publish identifiable imagery or video without the appropriate review and permissions."}
