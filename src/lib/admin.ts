...
export function sanitizeTalentRecord(input: unknown) {
  ...
  return {
    ...
    educationLevel: safePublicText(item.educationLevel, 120) || "",
    ...
    visibility: {
      ...
      educationLevelVisible: rawVisibility.educationLevelVisible === true,
...
export function toPublicTalentCard(id: string, input: unknown) {
  ...
  return {
    ...
    ...(record.visibility.educationLevelVisible && record.educationLevel ? { educationLevel: record.educationLevel } : {}),
    ...
    visibility: {
      ...
      educationLevelVisible: record.visibility.educationLevelVisible,
